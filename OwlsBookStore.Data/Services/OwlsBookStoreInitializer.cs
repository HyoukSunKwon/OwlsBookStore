    ...
    public class OwlsBookStoreInitializer : System.Data.Entity.DropCreateDatabaseIfModelChanges<OwlsBookStoreDbContext>
    {
        protected override void Seed(OwlsBookStoreDbContext context)
        {
            ...
            var writers = new List<Writer>
            {
                ...
                new Writer{ Name="Sarah J. Maas", BirthDate=DateTime.Parse("2000-09-01"), Portrayal="ddddd", UrlWriter="" },
                new Writer{ Name="Stephenie Meyer", BirthDate=DateTime.Parse("2000-09-01"), Portrayal="ddddd", UrlWriter="" }
            };
            ...
            {
                new Book{ Name="The lightning thief", ReleaseDate=DateTime.Parse("2005-01-01"), BookSeries=new BookSeries{Id = 1 }, UrlBook="https://www.google.com/search?rlz=1C1GCEA_enCA908CA908&biw=1349&bih=749&sxsrf=AOaemvKEmT-3D4yXsiJQo2wLUgKJAgt15Q:1633109579780&q=The+Lightning+Thief&stick=H4sIAAAAAAAAAONgFuLSz9U3MC82zSgqV-IEsdMK84osteSyk630k_Lzs_VzMktSixKLKuOLU4syU4utQILFjxh9uQVe_rgnLOUyac3Ja4x2XAQ0CElwsbnmlWSWVArxSfFwIdlqxaTByLOIVTgkI1XBJzM9oyQvMy9dISQjMzVtAhsjAAF1L0KiAAAA&sa=X&ved=2ahUKEwi2u4aj36nzAhXoFFkFHTDCC-AQ-BZ6BAgBEDQ&lei=UkZXYfy1OZev5NoPo8ul2Aw"},
                new Book{ Name="The sea of monster", ReleaseDate=DateTime.Parse("2006-01-01"), BookSeries=new BookSeries{Id = 1 }, UrlBook="https://www.google.com/search?rlz=1C1GCEA_enCA908CA908&biw=1349&bih=749&sxsrf=AOaemvKEmT-3D4yXsiJQo2wLUgKJAgt15Q:1633109579780&q=The+Sea+of+Monsters&stick=H4sIAAAAAAAAAONgFuLSz9U3MC82zSgqVwKzjcyycrItteSyk630k_Lzs_VzMktSixKLKuOLU4syU4utQILFjxh9uQVe_rgnLOUyac3Ja4x2XAQ0CElwsbnmlWSWVArxSfFwIVlrxaTByLOIVTgkI1UhODVRIT9NwTc_rxhoRvEENkYAtl2ew6MAAAA&sa=X&ved=2ahUKEwi2u4aj36nzAhXoFFkFHTDCC-AQ-BZ6BAgBEDc&lei=XUZXYfiIGYCi5NoPydyZ-AQ"},
                new Book{ Name="The titan's curse", ReleaseDate=DateTime.Parse("2007-01-01"), BookSeries=new BookSeries{Id = 1 }, UrlBook="https://www.google.com/search?rlz=1C1GCEA_enCA908CA908&sxsrf=AOaemvKEmT-3D4yXsiJQo2wLUgKJAgt15Q:1633109579780&q=The+Titan%27s+Curse&stick=H4sIAAAAAAAAAONgFuLSz9U3MC82zSgqVwKzjcyMC8sstOSyk630k_Lzs_VzMktSixKLKuOLU4syU4utQILFjxh9uQVe_rgnLOUyac3Ja4x2XAQ0CElwsbnmlWSWVArxSfFwIVlrxaTByLOIVTAkI1UhJLMkMU-9WMG5tKg4dQIbIwA7kb_EoQAAAA&sa=X&ved=2ahUKEwi2u4aj36nzAhXoFFkFHTDCC-AQ-BZ6BAgBEDo&lei=XUZXYfiIGYCi5NoPydyZ-AQ&biw=1349&bih=749&dpr=1.25"},
                new Book{ Name="Assassin's blade", ReleaseDate=DateTime.Parse("2005-01-01"), BookSeries=new BookSeries{Id = 2 }, UrlBook="https://sarahjmaas.com/wp-content/uploads/2015/06/AB-NYT-Cover.jpg"},
                new Book{ Name="Thron of glass", ReleaseDate=DateTime.Parse("2005-01-01"), BookSeries=new BookSeries{Id = 2 }, UrlBook="https://sarahjmaas.com/wp-content/uploads/2015/06/TOG-NYT-Cover.jpg"},
                new Book{ Name="Crown of midnight", ReleaseDate=DateTime.Parse("2005-01-01"), BookSeries=new BookSeries{Id = 2}, UrlBook="https://sarahjmaas.com/wp-content/uploads/2015/06/COM-NYT-Cover.jpg"},
                new Book{ Name="Twilight", ReleaseDate=DateTime.Parse("2005-10-05"), BookSeries=new BookSeries{Id = 3 }, UrlBook="https://stepheniemeyer.com/wp-content/uploads/2016/02/twilight-book-cover.jpg"}
            };
